...
(function(b) {
  ...
  function o(d) {
    return b('meta[name="' + d + '"]').attr("content") || "";
  }
  function t() {
    var d = o("DC.title"),
      a = o("DC.creator");
    d.length > 0 && a.length > 0 ? (d += " - " + a) : (d = b("title").text());
  ...
  b.fn.socialSharePrivacy = function(d) {
    var a = b.extend(
        !0,
        {
          services: {
      ...
      f = a.services.facebook.status === "on",
      j = a.services.twitter.status === "on",
      p = a.services.gplus.status === "on";
    if (f || j || p) {
      a.css_path.length > 0 &&
        b("head").append(
          '<link rel="stylesheet" type="text/css" href="' + a.css_path + '" />'
        );
      b(this).prepend('<ul class="social_share_privacy_area"></ul>');
      var c = b(".social_share_privacy_area", this),
        k = a.uri;
      typeof k === "function" && (k = k());
      return this.each(function() {
        if (f) {
          var e = encodeURIComponent(k + a.services.facebook.referrer_track),
            d =
          ...
          b(
            ...
            l.find("span.switch").hasClass("off")
              ? (l.addClass("info_off"),
                ...
                l.find("img.fb_like_privacy_dummy").replaceWith(d))
        ...
        if (j) {
          e = a.services.twitter.tweet_text;
          typeof e === "function" && (e = e());
          var e = y(e, "120"),
            q = encodeURIComponent(k + a.services.twitter.referrer_track),
            r = encodeURIComponent(k),
            t =
          ...
          var m = b("li.twitter", c);
          b("li.twitter div.tweet img,li.twitter span.switch", c).live(
            "click",
            function() {
              m.find("span.switch").hasClass("off")
                ? (m.addClass("info_off"),
                  ...
                  m.find("img.tweet_this_dummy").replaceWith(t))
        ...
        if (p) {
          var u =
              ...
              (k + a.services.gplus.referrer_track) +
          ...
          var n = b("li.gplus", c);
          b("li.gplus div.gplusone img,li.gplus span.switch", c).live(
            "click",
            function() {
              n.find("span.switch").hasClass("off")
                ? (n.addClass("info_off"),
                  n
                    .find("span.switch")
                    .addClass("on")
                  ...
                  n.find("img.gplus_one_dummy").replaceWith(u))
                : (n.removeClass("info_off"),
                  n
                    .find("span.switch")
                    .addClass("off")
                    .removeClass("on")
                    .html(a.services.gplus.txt_gplus_off),
                  n.find(".gplusone").html(w));
            }
          );
        }
        c.append(
        ...
        b(".help_info:not(.info_off)", c).live("mouseenter", function() {
          var a = b(this),
        ...
        b(".help_info", c).live("mouseleave", function() {
          var a = b(this).data("timeout_id");
          window.clearTimeout(a);
          b(this).hasClass("display") && b(this).removeClass("display");
        });
        e = a.services.facebook.perma_option === "on";
        q = a.services.twitter.perma_option === "on";
        r = a.services.gplus.perma_option === "on";
        if (
          ((f && e) || (j && q) || (p && r)) &&
          (!b.browser.msie || (b.browser.msie && b.browser.version > 7))
        ) {
          for (
            var i = document.cookie.split(";"), h = "{", s = 0;
            s < i.length;
            s += 1
          ) {
            var x = i[s].split("=");
            h += '"' + b.trim(x[0]) + '":"' + b.trim(x[1]) + '"';
            s < i.length - 1 && (h += ",");
          }
          h += "}";
          var h = JSON.parse(h),
            g = b("li.settings_info", c);
          g.find(".settings_info_menu").removeClass("perma_option_off");
          g.find(".settings_info_menu").append(
          ...
          f &&
            e &&
            ((i =
              h.socialSharePrivacy_facebook === "perma_on"
                ? ' checked="checked"'
                : ""),
            g
              .find("form fieldset")
          ...
          j &&
            q &&
            ((i =
              h.socialSharePrivacy_twitter === "perma_on"
                ? ' checked="checked"'
                : ""),
            g
              .find("form fieldset")
          ...
          p &&
            r &&
            ((i =
              h.socialSharePrivacy_gplus === "perma_on"
                ? ' checked="checked"'
                : ""),
            g
              .find("form fieldset")
          ...
          g.find("span.settings").css("cursor", "pointer");
          b(g.find("span.settings"), c).live("mouseenter", function() {
            var a = window.setTimeout(function() {
              g.find(".settings_info_menu")
                .removeClass("off")
                .addClass("on");
            }, 500);
            b(this).data("timeout_id", a);
          });
          b(g, c).live("mouseleave", function() {
            var a = b(this).data("timeout_id");
            window.clearTimeout(a);
            g.find(".settings_info_menu")
              .removeClass("on")
          ...
          b(g.find("fieldset input")).live("click", function(d) {
            var e = d.target.id,
              h =
                "socialSharePrivacy_" +
                e.substr(e.lastIndexOf("_") + 1, e.length);
            if (b("#" + d.target.id + ":checked").length) {
              var d = a.cookie_expires,
                g = a.cookie_path,
                f = a.cookie_domain,
                i = new Date();
              i.setTime(i.getTime() + d * 864e5);
              document.cookie =
                h +
                "=perma_on; expires=" +
                i.toUTCString() +
                ...
                "; domain=" +
                f;
              b("form fieldset label[for=" + e + "]", c).addClass("checked");
            } else (d = a.cookie_path), (g = a.cookie_domain), (f = new Date()), f.setTime(f.getTime() - 100), (document.cookie = h + "=perma_on; expires=" + f.toUTCString() + "; path=" + d + "; domain=" + g), b("form fieldset label[for=" + e + "]", c).removeClass("checked");
          });
          f &&
            e &&
            h.socialSharePrivacy_facebook === "perma_on" &&
            b("li.facebook span.switch", c).click();
          j &&
            q &&
            h.socialSharePrivacy_twitter === "perma_on" &&
            b("li.twitter span.switch", c).click();
          p &&
            r &&
            h.socialSharePrivacy_gplus === "perma_on" &&
            b("li.gplus span.switch", c).click();
        }
      });
    }
  };
